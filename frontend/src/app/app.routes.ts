...
import { StatisticsDashboardComponent } from './statistics/statistics-dashboard';
...
export const routes: Routes = [
  ...
  { path: 'admin/statistics', component: StatisticsDashboardComponent, canActivate: [AdminGuard] },
